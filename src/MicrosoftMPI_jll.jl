...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MicrosoftMPI_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9237b28f-5490-5468-be7b-bb81f5f5e6cf"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MicrosoftMPI", artifacts_toml) for e in artifacts["MicrosoftMPI"]]
...
if best_platform === nothing
    @debug("Unable to load MicrosoftMPI; unsupported platform $(triplet(platform_key_abi()))")
else
